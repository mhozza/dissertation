...
\paragraph{}Our method\cite{covest} was tested on several simulated datasets with various error rates and coverage as well as on real data --- E. coli (strain MG1655) --- subsampled for various coverage.
...
\caption{Comparison of genome coverage estimates obtained by the CovEst E
  ...
  produce answers for some inputs. }
